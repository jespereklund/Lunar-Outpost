    ...
    },
    {
        ...
        walls:
            [
                {x: 0, y: 0, w: 1000, h: 20}, //north
                {x: 0, y: 0, w: 20, h: 600}, //west
                {x: 980, y: 0, w: 20, h: 450}, //east
                {x: 0, y: 580, w: 1000, h: 20}, //south
                {x: 155, y: 150, w: 20, h: 450},
                {x: 310, y: 0, w: 20, h: 450, moveY: {yMin: 0, yMax: 150, dir: 1}},
                {x: 475, y: 150, w: 20, h: 450},
                {x: 640, y: 0, w: 20, h: 450},
                {x: 805, y: 150, w: 20, h: 450, moveY: {yMin: 0, yMax: 150, dir: -1}}
            ],
        ship: {x: 40, y: 470}
    },
]
